...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Edge_Slideshow::slides');
        $resultPage->addBreadcrumb(__('Slideshows'), __('Slideshows'));
    ...
    {
        return $this->_authorization->isAllowed('Edge_Slideshow::slides');
    }
